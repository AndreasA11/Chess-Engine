...
//most valuable victime, least valuable attacker table: 
//Move order that orders the capture moves from strongest to weakest
const int mvvLVA[12][12] = { //[attacker][victim]
